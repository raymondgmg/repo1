(function ($) {
    ...
    $offcanvasNav.on('click', 'li a, li .menu-expand', function(e) {
		...
		// document.getElementById('offcanvasMenu').addEventListener('shown.bs.offcanvas', () => {
		// 	setTimeout(() => {
		// 		document.body.style.overflow = 'scroll';
		// 	}, 2000);
		// });

		let ugames_thumbIndex = 1;
		setInterval(() => {
			ugames_thumbIndex++;
			if (ugames_thumbIndex == 4) ugames_thumbIndex = 1;

			$('#ugames_thumb').attr('src', `assets/img/others/game${ugames_thumbIndex}.png`);
		}, 3000);
